...
// Dummy components due to missing scrape
export const CardContainer = ({ children, className }: any) => (
  <div className={`perspective-1000 ${className}`}>{children}</div>
);
export const CardBody = ({ children, className }: any) => (
  <div className={`transform-style-3d ${className}`}>{children}</div>
);
export const CardItem = ({ as: Tag = "div", children, className, ...props }: any) => (
